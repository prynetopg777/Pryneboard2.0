...
def calculate_content_hash(text: str) -> str:
    """Generate SHA-256 hash for normalized text. Used for deduplication."""
    if not text:
        return ""
    # Normalize: strip wrappers and extreme whitespace to ensure semantic matches
    normalized = strip_pdf_content_marker(text).strip()
